...
<button class="button_link" role="button" onclick="hide_buttons('abstract_inetrav')">Abstract</button>
<div id="abstract_inetrav" style="display:none;">
...
with [Philippe Askenazy](http://www.jourdan.ens.fr/~askenazy/) and [Christine Erhel](https://ceet.cnam.fr/le-ceet/chercheur-euse-s/christine-erhel-lirsa-ceet--988265.kjsp), Connaissance de l'Emploi n°203, December 2024.
